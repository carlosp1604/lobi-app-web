...
export function CreateActivity({ sports }: CreateActivityProps) {
          ...
          {STEPS.map((step, idx) => {
            ...
            return (
              <ToggleGroupItem
                ...
                variant="outline"
                className={cn(
                  "cursor-pointer w-10 h-10 rounded-lg flex items-center justify-center text-sm font-medium transition-all duration-200",
                  hasError
                    ? "border-destructive text-destructive"
                    : isCompleted
                      ? "bg-primary border-primary text-primary-foreground hover:bg-primary/90 hover:text-primary-foreground data-[state=on]:bg-primary data-[state=on]:text-primary-foreground"
                      : isCurrent
                        ? "bg-background border-primary text-primary data-[state=on]:bg-background data-[state=on]:text-primary"
