        ...
        <div className="flex flex-col">
          { data.isSingleValue ? (
            ...
            <>
              ...
              { avgStr && (
                <div
                  className="flex items-center gap-1.5 mt-1 text-sm text-muted-foreground
                    font-medium bg-secondary/40 w-fit px-2 py-0.5 rounded"
                >
                  <TrendingUpIcon className="w-3.5 h-3.5" />
                  <span>
                    { t('activity_details_capabilities_average_title', { average: avgStr }) }
                  </span>
                </div>
              ) }
            </>
