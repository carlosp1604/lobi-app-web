...
export function SecuritySettings({ onSessionClosed }: SecurityTabProps) {
            ...
            <div className="flex flex-col space-y-1">
              ...
              <span className="text-muted-foreground tracking-tight">
                  ...
                  t('user_security_security_settings_password_never_modified_title') }
                {
                  ...
                  t('user_security_security_settings_password_last_modified_title', { time: getRelativeDateTitle(credential.lastModifiedAt)})
                }
              </span>
            </div>
