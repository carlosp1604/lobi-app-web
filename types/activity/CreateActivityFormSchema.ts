...
export const createCreateActivityFormSchema = (
  ...
  const baseSchema = {
    title: z
      .string()
      .min(MIN_ACTIVITY_TITLE_LENGTH,
        { error: t('activity_title_too_short_message_title', { minLength: MIN_ACTIVITY_TITLE_LENGTH }) })
      .max(MAX_ACTIVITY_TITLE_LENGTH,
        { error: t('activity_title_too_long_message_title', { maxLength: MAX_ACTIVITY_TITLE_LENGTH }) })
    ...
    description: z.string()
      ...
      .refine((value) => {
        ...
        return ActivityDescriptionRegex.test(value)
      }, {
